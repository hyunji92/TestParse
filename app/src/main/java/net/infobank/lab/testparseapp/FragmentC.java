...
public class FragmentC extends Fragment implements View.OnClickListener {
    ...
    private Button mAddData3;
    private Button mLoadData3;
    private TextView mData3;


    public static FragmentC newInstance(CharSequence label) {
        FragmentC f;
        f = new FragmentC();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAddData3 = (Button) view.findViewById(R.id.button_c);
        mLoadData3 = (Button) view.findViewById(R.id.button2_c);
        mData3 = (TextView) view.findViewById(R.id.textView_c);

        mAddData3.setOnClickListener(this);
        mLoadData3.setOnClickListener(this);
    ...
    private void loadData() {
        try {
            ...
            query.whereEqualTo("test_type", 3); // my_type이 1인 object만 읽어옴. 해당 함수 호출하지 않으면 class의 모든 데이터를 읽어옴.
            ...
            mData3.setText(str.toString()); // TextView에 데이터를 넣어준다.
            datas.clear();
